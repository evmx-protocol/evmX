...
//  evmX -- Main Contract
// ===============================================================================
contract evmX is ERC20, Ownable, ReentrancyGuard {
    ...
    address private constant UNISWAP_V2_ROUTER_ADDRESS = 0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24;
    address private constant VRF_COORDINATOR_ADDRESS    = 0xd5D517aBE5cF79B7e95eC98dB0f0277788aFF634;
    bytes32 private constant VRF_KEY_HASH               = 0xdc2f87677b01473c763cb0aee938ed3341512f6057324a584e5944e786144d70;
    ...
    constructor(
        ...
        IVRFCoordinatorV2Plus coordinator = IVRFCoordinatorV2Plus(VRF_COORDINATOR_ADDRESS);
    ...
    receive() external payable {
        if (msg.value > 0 && !inSwap) {
            if (msg.sender == VRF_COORDINATOR_ADDRESS) {
    ...
    function rawFulfillRandomWords(uint256 requestId, uint256[] calldata randomWords) external {
        if (msg.sender != VRF_COORDINATOR_ADDRESS) revert OnlyCoordinator();
